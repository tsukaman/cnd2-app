...
📱 **v1.12.0アップデート**: イベント参加者向けのUXがさらに改善されました。  
- トレードマーク画像からCloudNative Days Winter 2025サイトへの直接リンク  
- 一般参加者に不要なメトリクス機能を削除  
- SSR対応の強化でCloudflare Pagesデプロイの安定性向上  
- アクセシビリティ属性（aria-label）の追加
...
*最終更新: 2025-09-07*
*CloudNative Days Winter 2025 用 v1.12.0*