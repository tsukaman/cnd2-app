...
必ず以下のJSON形式で出力してください：
{
  "diagnosis": {
    ...
    "conversationStarters": [
      "2人のプロフィールから導き出される具体的で多様な話題を5つ。必ずクラウドネイティブ技術の話題を3個以上含める",
      "例：『Kubernetesでの最大のやらかしエピソードは？』",
      "例：『理想のCI/CDパイプラインについて熱く語ってください』", 
      "例：『サーバーレスとコンテナ、どっち派？その理由は？』",
      "例：『今まで出会った中で最も厄介だったバグは？』"
    ],
