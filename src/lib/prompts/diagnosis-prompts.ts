...
診断はエンターテイメントとして楽しく、どんなスコアでも前向きなメッセージを含めてください。`,
  ...
  USER_TEMPLATE: `以下の2人のX (Twitter)プロフィールから相性を診断してください。
プロフィールには、ツイート内容、フォロワー数、興味のあるトピック、技術スタックなどが含まれています。
...
6. 【X (Twitter)プロフィール特有の分析】
- ツイートの内容と傾向から見る性格分析
- フォロワー数とエンゲージメント率から見る影響力の相性
- ハッシュタグとトピックから見る興味の共鳴
- アクティブな時間帯から見るライフスタイルの調和
